<?php
class PB_Tasks_List_Table extends WP_List_Table {
    ...
    function column_completed($item){
    ...
    function column_project($item){
        return pb_filter_data('projects', $item['project_id']);
    }    
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            'task_name'     => array('task_name',true),     //true means its already sorted
